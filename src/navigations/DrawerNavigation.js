    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => (
            <View className="flex justify-center items-center w-6 h-6">
              <Foundation name="clipboard-notes" size={24} color="#3422F1" />
            </View>
          ),
          headerLeft: (props) => (
            <TouchableOpacity
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => (
            <View className="flex justify-center items-center w-6 h-6">
              <MaterialCommunityIcons name="sale" size={24} color="#3422F1" />
            </View>
          ),
          headerLeft: (props) => (
            <TouchableOpacity
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => (
            <View className="flex justify-center items-center w-6 h-6">
              <Fontisto name="persons" size={24} color="#3422F1" />
            </View>
          ),
          headerLeft: (props) => (
            <TouchableOpacity
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => (
            <View className="flex justify-center items-center w-6 h-6">
              <Feather name="gift" size={24} color="#3422F1" />
            </View>
          ),
          headerLeft: (props) => (
            <TouchableOpacity
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => (
            <View className="flex justify-center items-center w-6 h-6">
              <Feather name="settings" size={24} color="#3422F1" />
            </View>
          ),
          headerLeft: (props) => (
            <TouchableOpacity
