...
import { formatCurrency, formatMomentDateToVietnamese, getTitleDependStatus } from '../../features/ultils';
    ...
    return (
        ...
        >
            <View className="border-b border-gray-300 pb-3 px-4">
                <Text className="text-base font-medium">{getTitleDependStatus(order.status)}</Text>
            </View>
