        ...
        <View className="flex-1 bg-white">
            <ScrollView className="flex-1 bg-white py-4 px-4" showsVerticalScrollIndicator={false}>
                ...
                <View className="flex-col py-3 border-b border-gray-200">
                    ...
                    {categories.map(ele => (
                        <TouchableOpacity
                            onPress={() => updateProductDetail({ selectedCategory: productDetail.selectedCategory === ele.id ? null : ele.id })}
                            key={ele.id}
                        ...
                        >
                            ...
                            <View>
                                <CheckBox
                                    ...
                                    onClick={() => updateProductDetail({ selectedCategory: productDetail.selectedCategory === ele.id ? null : ele.id })}
                    ...
                    <FlatList
                        ...
                        renderItem={c => (
                            <TouchableHighlight
                                ...
                                style={productDetail.checkedMass === c.item.id && { borderBlockColor: "#3422F1", backgroundColor: 'rgba(134, 182, 246, 0.4)' }}
                                onPress={() => updateProductDetail({
                                    checkedMass: productDetail.checkedMass === c.item.id ? null : c.item.id
                                })}
                            >
                                <Text
                                    className="text-black font-medium"
                                    style={productDetail.checkedMass === c.item.id && { color: "#3422F1" }}
                                >
                                    {c.item.name}
                                </Text>
                            </TouchableHighlight>
                ...
                <View className="flex-col py-6 mb-36">
                    ...
                    <TouchableOpacity
                        ...
                        style={productDetail.image && { backgroundColor: 'rgb(147, 197, 253)' }}
                    >
                        {productDetail.image ? (
                            <>
