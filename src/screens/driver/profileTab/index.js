...
const ProfileTab = ({ navigation }) => {
  ...
  return (
    <SafeAreaView className="flex-1 flex-col relative items-center">
      <View
        className="w-40 h-16 bg-white border-2 border-gray-200 shadow-lg absolute z-10 rounded-3xl flex-row justify-center items-center space-x-2"
        style={{ top: top }}
      >
        ...
        <TouchableOpacity className="flex-row justify-between items-center py-4">
          <View className="flex-row space-x-2 items-center ">
            ...
            <Text className="text-md font-semibold text-gray-500">
              Giới thiệu đối tác, nhận thưởng ngay
            </Text>
          </View>
